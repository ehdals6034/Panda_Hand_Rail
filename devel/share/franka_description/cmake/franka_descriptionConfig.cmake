...
if("TRUE" STREQUAL "TRUE")
  set(franka_description_SOURCE_PREFIX /panda_ws/src/franka_description)
  set(franka_description_DEVEL_PREFIX /panda_ws/devel)
  ...
  set(franka_description_INSTALL_PREFIX /panda_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/panda_ws/src/franka_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /panda_ws/devel/lib;/panda_ws/devel/lib;/ros_ws/devel/lib;/opt/ros/melodic/lib)
